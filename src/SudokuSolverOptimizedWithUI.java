...
public class SudokuSolverOptimizedWithUI {
    ...
    private List<List<String>> traverseSolutionSpace(List<List<List<String>>> solutionSpace) {
    ...
    public static void main(String[] args) {
        ...
        new SudokuSolverOptimizedWithUI().solve(b);
